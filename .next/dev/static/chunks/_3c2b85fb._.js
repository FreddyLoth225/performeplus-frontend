...
function OwnerDashboard() {
    ...
    if ($[0] !== "5abf669b9dd988b64e8b3d387aa50e2f6139100fc3ec8dd4906972ad58d69f6b") {
        for(let $i = 0; $i < 39; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "5abf669b9dd988b64e8b3d387aa50e2f6139100fc3ec8dd4906972ad58d69f6b";
    }
    ...
    const { data: dashboard, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$hooks$2f$use$2d$dashboard$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDashboardStaff"])(currentTeam?.id);
    if (isLoading) {
        let t0;
    ...
    const t7 = dashboard?.equipe.joueurs_actifs || 0;
    let t8;
    if ($[10] !== t7) {
...
_s(OwnerDashboard, "L5gca5rMzSWxGxsPf/KrKyzJu7I=", false, function() {
    return [
...
//# sourceMappingURL=_3c2b85fb._.js.map