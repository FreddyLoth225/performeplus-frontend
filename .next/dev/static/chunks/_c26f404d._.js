...
const useAuth = ()=>{
    ...
    if ($[0] !== "66a7f8414bec178f5e4d27c644516519b5017032c4a0bbecb4de5727358b44f4") {
        for(let $i = 0; $i < 23; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "66a7f8414bec178f5e4d27c644516519b5017032c4a0bbecb4de5727358b44f4";
    }
    const { setUser, logout: storeLogout } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2f$auth$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])();
    ...
    if ($[2] === Symbol.for("react.memo_cache_sentinel")) {
        t1 = {
            queryKey: t0,
            queryFn: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$auth$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].getCurrentUser,
            retry: false,
    ...
    const { data: user, isLoading, isError, refetch } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])(t1);
    let t2;
    if ($[3] !== queryClient || $[4] !== router || $[5] !== setUser) {
        t2 = {
            mutationFn: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$auth$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].login,
            onSuccess: (userData)=>{
                console.log("\u2705 Connexion r\xE9ussie, mise \xE0 jour du store:", userData);
                setUser(userData);
    ...
    const loginMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])(t2);
    let t3;
    if ($[7] !== router) {
        t3 = {
            mutationFn: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$auth$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].register,
            onSuccess: ()=>{
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Inscription r\xE9ussie ! V\xE9rifiez votre email.");
                router.push("/login");
            },
            onError: _temp2
        };
    ...
    const registerMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])(t3);
    let t4;
    if ($[9] !== queryClient || $[10] !== router || $[11] !== storeLogout) {
        t4 = async ()=>{
            ;
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$auth$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].logout();
                storeLogout();
                queryClient.clear();
                ...
                const error_1 = t5;
                console.error("Erreur lors de la d\xE9connexion:", error_1);
            }
        };
        $[9] = queryClient;
        $[10] = router;
    ...
    const logout = t4;
    let t5;
    if ($[13] !== isError || $[14] !== isLoading || $[15] !== loginMutation.isPending || $[16] !== loginMutation.mutate || $[17] !== logout || $[18] !== refetch || $[19] !== registerMutation.isPending || $[20] !== registerMutation.mutate || $[21] !== user) {
        t5 = {
            user,
            isLoading,
            isError,
        ...
        $[13] = isError;
        $[14] = isLoading;
        $[15] = loginMutation.isPending;
        $[16] = loginMutation.mutate;
        $[17] = logout;
        $[18] = refetch;
        $[19] = registerMutation.isPending;
        $[20] = registerMutation.mutate;
        $[21] = user;
        $[22] = t5;
    } else {
        t5 = $[22];
...
_s(useAuth, "wFJKfj8DyM+TS3d1DUaYYNXdeOY=", false, function() {
    return [
...
function _temp(error) {
    ...
    const message = error.response?.data?.detail || error.response?.data?.error || "Identifiants incorrects";
...
function _temp2(error_0) {
    const message_0 = error_0.response?.data?.email?.[0] || "Erreur lors de l'inscription";
...
function Sidebar() {
    ...
    if ($[0] !== "2cc0e038548c08a83324b63e706c1949e69f544e56ef42a1b8b1653d72e0f7bf") {
        for(let $i = 0; $i < 81; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "2cc0e038548c08a83324b63e706c1949e69f544e56ef42a1b8b1653d72e0f7bf";
    }
...
function DashboardLayout(t0) {
    ...
    if ($[0] !== "90a097a367747a661435b0ead996a25ce7e77e2139555729beea474f53438a73") {
        for(let $i = 0; $i < 10; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "90a097a367747a661435b0ead996a25ce7e77e2139555729beea474f53438a73";
    }
    const { children } = t0;
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const { isAuthenticated } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2f$auth$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])();
    const { user, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$hooks$2f$use$2d$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    let t1;
    let t2;
    if ($[1] !== isAuthenticated || $[2] !== isLoading || $[3] !== router) {
        t1 = ({
            "DashboardLayout[useEffect()]": ()=>{
                if (!isLoading && !isAuthenticated && ("TURBOPACK compile-time value", "object") !== "undefined") {
                    const token = localStorage.getItem("access_token");
                    if (!token) {
                        console.log("\uD83D\uDD12 Aucun token trouv\xE9, redirection vers /login");
                        router.push("/login");
                    }
                }
            }
...
_s(DashboardLayout, "Ac29X6rYLdHjW6xM39AnNjmrnvY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2f$auth$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$hooks$2f$use$2d$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
...
//# sourceMappingURL=_c26f404d._.js.map