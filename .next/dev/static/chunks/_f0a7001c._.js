...
function PlayerDashboard() {
    ...
    if ($[0] !== "8971133b89834d06e3858185b74a3a50b69fa867b3fdac8a6977f1e9ab747905") {
        for(let $i = 0; $i < 73; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "8971133b89834d06e3858185b74a3a50b69fa867b3fdac8a6977f1e9ab747905";
    }
    ...
    const { data: dashboard, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$hooks$2f$use$2d$dashboard$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDashboardJoueur"])(currentTeam?.id);
    ...
    const t5 = dashboard?.indice_forme_jour?.score;
    let t6;
    if ($[8] !== t5) {
        t6 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("text-2xl font-bold", getScoreColor(t5));
        $[8] = t5;
        $[9] = t6;
    } else {
        t6 = $[9];
    }
    const t7 = dashboard?.indice_forme_jour?.score ? `${dashboard.indice_forme_jour.score}/28` : "--/28";
    let t8;
    if ($[10] !== t6 || $[11] !== t7) {
    ...
    const t9 = dashboard?.indice_forme_jour?.score;
    let t10;
    if ($[13] !== t9) {
        t10 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("text-xs mt-1", getScoreColor(t9));
        $[13] = t9;
        $[14] = t10;
    } else {
        t10 = $[14];
    }
    const t11 = dashboard?.indice_forme_jour?.interpretation.message || "Non saisi";
    let t12;
    if ($[15] !== t10 || $[16] !== t11) {
    ...
    const t16 = dashboard?.statistiques_periode.nombre_seances || 0;
    let t17;
    if ($[25] !== t16) {
    ...
    let t18;
    if ($[27] !== dashboard) {
        t18 = dashboard?.statistiques_periode.nombre_seances ? `Charge moyenne: ${dashboard.statistiques_periode.charge_moyenne.toFixed(0)}` : "Aucune s\xE9ance r\xE9cente";
        $[27] = dashboard;
        $[28] = t18;
    } else {
        t18 = $[28];
    ...
    let t22;
    if ($[35] !== dashboard?.statistiques_periode.charge_totale) {
        t22 = dashboard?.statistiques_periode.charge_totale.toFixed(0) || 0;
        $[35] = dashboard?.statistiques_periode.charge_totale;
        $[36] = t22;
    } else {
        t22 = $[36];
    }
    ...
    const t27 = dashboard?.seances_sans_rpe || 0;
    let t28;
    if ($[43] !== t27) {
    ...
    const t29 = dashboard?.seances_sans_rpe ? "Saisies en attente" : "Aucune saisie en attente";
    let t30;
    if ($[45] !== t29) {
    ...
    let t32;
    if ($[50] !== t14 || $[51] !== t20 || $[52] !== t25 || $[53] !== t31) {
...
_s(PlayerDashboard, "lZPAEbBmrwHZwhYQ3oprzF+ZXZ4=", false, function() {
    return [
...
//# sourceMappingURL=_f0a7001c._.js.map